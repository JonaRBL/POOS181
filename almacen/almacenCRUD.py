...
values3 = ("Bebida energetica", "Refresco", "Agua","Alcoholica","Jugo")
varClas = ttk.Combobox(pestana1, values=values3)
varClas.pack()

lblMar = Label(pestana1, text = "Marca: ").pack()
values4 = ("CocaCola", "Epura", "Ciel","Pepsi","Jumex","Peñafiel")
varMar= ttk.Combobox(pestana1, values=values4)
varMar.pack()
...
values2 = ("Bebida energetica", "Refresco", "Agua","Alcoholica","Jugo")
varaClas = ttk.Combobox(pestana3, values=values2)
varaClas.pack()
lanMar = Label(pestana3, text = "Nueva Marca: ").pack()
values1 = ("CocaCola", "Epura", "Ciel","Pepsi","Jumex","Peñafiel")
varaMar= ttk.Combobox(pestana3, values=values1)
varaMar.pack()
...
values1 = ("CocaCola", "Epura", "Ciel","Pepsi","Jumex","Peñafiel")
varMarca= ttk.Combobox(pestana5, values=values1)
varMarca.pack()
...
values = ("Bebida energetica", "Refresco", "Agua","Alcoholica","Jugo")
varClasi= ttk.Combobox(pestana5, values=values)
varClasi.pack()
